...
3. Find the KODO icon on the desktop and run it. Enter the server IP address or its name, username and password \(check the "Remember me" box\). Click the **Log in** button.
